...
import BarIcon from "./icons/bar.svg"; // Adjust the path after moving the SVG inside src/
...
const GetStarted = () => {
  ...
  return (
    <div className="getstarted-wrapper">
      {/* Add the SVG image above the heading */}
      <img src={BarIcon} alt="Bar Icon" className="bar-icon" />
          ...
          {steps.map((step, index) => (
            <div className="stepper-step" key={index}>
              ...
              <div className="stepper-content">
                <h6 className="stepper-heading">{step.title}</h6>
